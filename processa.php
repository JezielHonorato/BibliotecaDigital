<?php
    ...
    $categoriav = isset($_GET['categoria']) ? $_GET['categoria'] : "";
    ...
    $condicoes ? $sql_code_livro .= " WHERE " . implode(" AND ", $condicoes) : "";

    $sql_code_livro .= " $ordem";
    $sql_query_livro = $conexao->query($sql_code_livro) or die($sql_code_livro);
